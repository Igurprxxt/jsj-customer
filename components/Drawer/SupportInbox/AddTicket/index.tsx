      ...
      <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
        <View
          ...
          <DefaultTextInput
            ...
            className={cn(
              '  w-full rounded-lg  font-poppinsMedium text-sm dark:bg-[#1A212A] dark:text-white '
            )}
          ...
          <DefaultTextInput
            ...
            placeholderTextColor={theme.colors.dashboard_card_text}
            className={cn(
              ' min-h-[100px] w-full rounded-lg  font-poppinsMedium text-sm dark:bg-[#1A212A] dark:text-white'
            )}
