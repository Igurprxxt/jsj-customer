...
const RenderItem = ({ item, onEdit }: any) => {
  ...
  const { isDarkTheme, colorScheme, showToast }: any = useTheme();
  ...
  return (
    <View className="flex-row items-center rounded-lg bg-gray-200 p-4 dark:bg-account_table_bg">
      <View className="flex-1">
        <Text className="font-poppinsMedium text-tertiary dark:text-white">{item.accountName}</Text>
      </View>

      <View className="flex-1 items-center justify-center">
        <Text className="font-poppinsMedium text-tertiary dark:text-white ">
      ...
      <View className="flex-2 flex-row items-end justify-end space-x-4">
        <TouchableOpacity
          ...
          <FontAwesome6
            name="edit"
            size={18}
            color={isDarkTheme ? theme.colors.dashboard_card_text : theme.colors.tertiary}
          />
        </TouchableOpacity>
        ...
        <ConfirmationModal
          ...
          icon={
            <TouchableOpacity
              ...
              <DeleteSVG
                fill={isDarkTheme ? theme.colors.dashboard_card_text : theme.colors.tertiary}
              />
            </TouchableOpacity>
          }
        />
