...
const AddAccount = ({ open, setOpen }: any) => {
  ...
  const errCb = useCallback((err: any) => {
    setLoading(false);
          ...
          <View className="w-full gap-y-5 rounded-xl bg-white p-5 dark:bg-analytics_card">
            ...
            <View className="gap-y-2">
              {/* {Platform.OS === 'ios' ? (
                ...
                <> */}
              <Text className="text-base font-semibold text-tertiary dark:text-white">
                Calculation Method
              </Text>
              <SelectAccount
                options={{
                ...
                className="w-full rounded-lg border-[1px] border-gray-400 bg-dashboard_card p-3 dark:border-2 dark:border-gray-600 dark:text-white"
              />
              {/* </>
              )} */}
            </View>
