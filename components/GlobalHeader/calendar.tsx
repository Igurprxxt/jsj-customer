  ...
  return (
    <View>
      <TouchableOpacity
        ...
        <Ionicons name="calendar-outline" size={23} className="!text-black dark:!text-white" />
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        ...
                        // });
                        setSelectedRange({
                          startDate: convertTimezone(range?.value[0], user?.timeZone),
                          endDate: convertTimezone(range?.value[1], user?.timeZone),
                        });
                      }}
                ...
                <View>
                  {selectedRange?.startDate ? (
                    <Text
                      ...
                      {dayjs(selectedRange?.startDate).format('YYYY-MM-DD')}{' '}
                      {selectedRange?.endDate ? ' ~' : ''}{' '}
                      {selectedRange?.endDate
                        ? dayjs(selectedRange?.endDate).format('YYYY-MM-DD')
                        : null}
                    </Text>
                  ) : (
                ...
                onPress={() => {
                  ...
                  setQuery({
                    startDate: selectedRange?.startDate
                      ? convertTimezone(selectedRange?.startDate, user?.timeZone)
                      : null,
                    endDate:
