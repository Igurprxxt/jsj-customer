...
const Dropdown: React.FC<DropdownProps> = ({ options, placeholder }) => {
  ...
  // Access navigation state (example)

  //  Example Logic, not recommended if you only want to check current route
  ...
  return (
    <View style={styles.container} className="">
      <TouchableOpacity
        ...
        <Text className={cn('font-interMedium text-base text-tertiary dark:text-white')}>
          {placeholder}
        </Text>
      ...
      <Modal
        ...
        {buttonLayout && (
          <Animated.View
            ...
            className={cn('rounded-lg !bg-white dark:!bg-dashboard_card')}>
            <Animated.FlatList
              data={options}
